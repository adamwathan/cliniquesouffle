...
?>
    ...
    <section class="py-20">
        <div class="container">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 px-0 lg:px-5">
                <div>
                    <p>
                        Leader de leur domaine, les Cliniques du Souffle Korian développent depuis près de 30 ans le
                        concept de la
                        <strong>réhabilitation santé</strong>. Ce concept se base sur <strong>une approche
                            globale et intégrative</strong> avec pour objectif de
                        remettre en mouvement le patient, en le <strong>rendant acteur de sa propre santé</strong>.
                        Cette méthode
                        consiste à associer
                        au traitement médicamenteux classique et nécessaire, un accompagnement physique, psychique et
                        nutritionnel
                        du malade.
                    </p>
                    <p>
                        <strong>Aujourd'hui classée Grade A</strong>, l'efficacité de ce domaine <strong>est reconnue
                            par toutes les sociétés
                            scientifiques
                            internationales</strong>, au point de s'élargir à d'autres pathologies comme <strong>les affections
                            métaboliques,
                            de la
                            nutrition, du sommeil et des addictions</strong>. En inscrivant la recherche et l'innovation médicale au
                        coeur de sa
    ...
    <section class="cliniques py-20" id="cliniques">
        <div class="container">
            ...
            <div class="text-primary-default font-open italic uppercase text-3xl">Réhabilitation respiratoire et
                métabolique
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 py-10">
                ...
                <div class="clinique">
                    ...
                    <div class="link">
                        <a href="https://www.korian.fr/clinique-ssr/ssr-korian-les-acacias-briancon-05100"
                           target="_blank">
                            En savoir plus >
                        </a>
                    </div>
